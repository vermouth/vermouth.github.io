...
// project variables
const projectsItem = document.querySelectorAll(".project-item");
...
for (let i = 0; i < projectsItem.length; i++) {
  ...
  projectsItem[i].addEventListener("click", function () {
    ...
    modalText.innerHTML = this.querySelector("[data-description]").innerHTML;
    
    let videos = modalText.querySelectorAll("iframe")
